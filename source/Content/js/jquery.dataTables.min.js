...
sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"ראשון",sLast:"אחרון",sNext:" הבא ",sPrevious:"הקודם "},sEmptyTable:"אין משתמשים",sInfo:"מראה _START_ עד _END_ מתוך _TOTAL_ משתמשים",sInfoEmpty:"מראה אפס משתמשים",sInfoFiltered:"(סונן מתוך _MAX_ משתמשים)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"הצגת _MENU_ משתמשים",sLoadingRecords:"טוען...",sProcessing:"מעבד...",sSearch:"חיפוש:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"אין תוצאות"},
